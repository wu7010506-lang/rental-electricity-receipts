...
function UsageTable({rows,setRows,heading,description,showContacts=false,showCurrentFields=false,showPrintButton=false,sourceRows}:{rows:Tenant[];setRows:React.Dispatch<React.SetStateAction<Tenant[]>>;heading:string;description:string;showContacts?:boolean;showCurrentFields?:boolean;showPrintButton?:boolean;sourceRows?:Tenant[]}) {
